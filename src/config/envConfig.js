...
// RAZORPAY
const RAZORPAY_APIKEY = process.env.RAZORPAY_APIKEY;
const RAZORPAY_SECRETKEY = process.env.RAZORPAY_SECRETKEY;

export { DB_CONFIG, NODE_ENV, PORT, ACCESS_TOKEN_SECRET, ACCESS_TOKEN_EXPIRY, REFRESH_TOKEN_SECRET, REFRESH_TOKEN_EXPIRY, MAILTRAP_USER, MAILTRAP_PASS, MAILTRAP_HOST, MAILTRAP_PORT, VERIFICATION_URL, CLOUDINARY_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET, RAZORPAY_APIKEY, RAZORPAY_SECRETKEY };
